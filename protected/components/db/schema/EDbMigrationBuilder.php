...
class EDbMigrationBuilder extends CComponent
{
	...
	public function __construct($db, $tmpDb, EMigrateCommand $command=null)
	{
		$this->_db = $db;
		$this->_tmpDb = $tmpDb;
	...
	{
		return Yii::getPathOfAlias($this->_command->migrationPath).DIRECTORY_SEPARATOR.$this->getName().'.php';
	}
